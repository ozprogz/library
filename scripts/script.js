let myLibrary =[];
const firstExampleBook = new Book("Harry Potter and the Philosopher's Stone", "J. K. Rowling", 223, "read");
const secondExampleBook = new Book("Harry Potter and the Chamber of Secrets", "J. K. Rowling", 251, "not read");
const thirdExampleBook = new Book("The Great Gatsby", "F. Scott Fitzgerald", 180, "read");
...
addBookButton.addEventListener("click", ()=> document.getElementById("01").style.display="block");
const declineButton = document.querySelector(".decline");
declineButton.addEventListener("click", ()=> document.getElementById("01").style.display="none");
